...
```{r Biomass figures, fig.width=8, fig.cap="**Figure 6.** *Physiology figures are mean +/-SE with  *Montipora capitata*  on the left, *Porites compressa* on the right*"}
...
```{r, warning=FALSE, message=FALSE, results='hide', fig.width=8}
